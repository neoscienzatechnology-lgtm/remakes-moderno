...
export const Route = createFileRoute("/kids-ia")({
  head: () => ({
    meta: [
      { title: "Kids IA · Tecnologia, Automacao e IA para Criancas · Remington" },
    ...
    <SiteShell>
        ...
        <div className="relative container mx-auto px-4 md:px-6 py-20 lg:py-28">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-3xl">
            ...
            <h1 className="font-display font-bold text-white leading-[1.02] tracking-tight">
              <span className="block text-5xl sm:text-6xl lg:text-7xl">Kids IA</span>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <CourseEnrollDialog courseName="Kids IA" Icon={Bot} triggerLabel="Aula experimental gratuita" />
              <Link to="/contato"
      ...
      <section className="py-20 lg:py-24 bg-white/[0.02]">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <p className="mt-6 text-white/55 text-base lg:text-lg leading-relaxed">
            O Kids IA vai alem da informatica basica. Em 24 meses, criancas e adolescentes aprendem IA, robotica com Arduino real, programacao Scratch, modelagem 3D com impressao real e desenvolvimento de apps para Android — tudo de forma ludica e pratica.
          </p>
      ...
      <section className="py-20 lg:py-28 bg-white/[0.02]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-12">
            Por que o <span className="text-gradient">Kids IA</span>?
          </h2>
